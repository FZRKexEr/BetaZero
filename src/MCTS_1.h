...
#ifndef BETAZERO_MCTS_1_H
#define BETAZERO_MCTS_1_H
...
public:
  ...
  // 初始化
  MCTS_1(double time_limit, int search_limit) : Time_Limit(time_limit), Search_Times(search_limit) {
    win_per = -1.0;
    draw_per = -1.0;
    search_nums = 0;
    select_time = 0.0;
